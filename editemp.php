...
<body style="background-color:#95a5a6"/>
   ...
   <tr>
	...
	<div class="container">
	<h3 style="text-align=center"> EDIT EMPLOYEE INFO </h3>
	<?php
	$a='';
		...
		<html>
			...
			<form class="loginform" action="editemp.php" method="post">
			<input type="text" name="name" class="form-control" placeholder="name" /><br>
			<input type="text" name="address" class="form-control" placeholder="address" /><br>
			<input type="text" name="sex" class="form-control" placeholder="sex" /><br>
	...
	<?php		
			if(isset($_POST['submit']))
			{
				...
				$sqll="update employee set name='$name',address='$address',sex='$sex',salary='$salary',dno='$dno' where ssn='$xx'";
				$con->query($sqll);
