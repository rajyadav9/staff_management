...
<body style="background-color:#95a5a6">
	...
	<div style="background-image:url(img/a.png); background-size:cover; height:660px; ">
	<div >
   ...
   <tr>
	...
	<a href="adde.php"><input  style="font-weight:bold" type="button" name="adde" value="ADD EMPLOYEE" id="btnn" class="btn-primary"/></a>
	<center>
