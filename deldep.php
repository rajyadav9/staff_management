...
<table height="100%" width="100%" cellpadding="0" cellspacing="0" border="0">
    <tr>
    <td valign="top" align="left" background="img/m.jpeg" style="background-repeat:no-repeat; background-size:cover;height:650px;"> 
	...
	<div class="container">
	<h1 style="color:black;"><b>EDIT DEPARTMENT INFO</b></h1>
	<?php
	$a='';
		...
		<html>
			...
			<form class="loginform" action="deldep.php" method="post">
