...
<body style="background-color:#95a5a6";/>
   ...
   <tr>
	...
	<div class="container">
	<h3 style="text-align=center"> EDIT PROJECT INFO </h3>
	<?php
	$a='';
		...
		<html>
			...
			<form class="loginform" action="editpro.php" method="post">
			<input type="text" name="pname" class="form-control" placeholder="project name" /><br>
			<input type="text" name="ploc" class="form-control" placeholder="project location" /><br>
			<input type="text" name="dno" class="form-control" placeholder="department no" /><br>
	...
	<?php		
			if(isset($_POST['submit']))
			{
				...
				$sqll="update project set pname='$pname',plocation='$plocs',dno='$dno' where pno='$xx'";
				$con->query($sqll);
