...
<table height="100%" width="100%" cellpadding="0" cellspacing="0" border="0">
    <tr>
    <td valign="top" align="left" background="img/a.png" style="background-repeat:no-repeat; background-size:cover;height:750px;"> 
	...
	<div class="container">
	<h3 style="text-align=center"> DELETE DEPARTMENT LOCATION INFO</h3>
	<?php
	$a='';
		...
		<html>
			...
			<form class="loginform" action="deldloc.php" method="post">
