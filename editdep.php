...
<body style="background-color:#95a5a6";/>
   ...
   <tr>
	...
	<div class="container">
	<h3 style="text-align=center"> EDIT DEPARTMENT INFO</h3>
	<?php
	$a='';
		$sql="select * from department where dno='$a'";
		$res=$con->query($sql);
		?>
		<html>
	
			<form class="loginform" action="editdep.php" method="post">
			
			
			<input type="text" name="dno" class="form-control" placeholder="dno" /><br>
			<input type="text" name="name" class="form-control" placeholder="department name" /><br>
	...
	<?php		
			if(isset($_POST['submit']))
			{
				...
				$sqll="update department set dno='$dno',dname='$name' where dno='$xx'";
				$con->query($sqll);
