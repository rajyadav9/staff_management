...
<body style="background-color:#95a5a6";/>
    ...
    <tr>
    <td valign="top" align="left" background="img/g.jpeg" style="background-repeat:no-repeat; background-size:cover;height:750px;"> 
	...
	<div class="container">
		<h1 style="color:black;"><b>DELETE EMPLOYEE WORKING ON PROJECT INFO</b></h1>
	<?php
	$a='';
		...
		<html>
			...
			<form class="loginform" action="delwork.php" method="post">
	...
	<?php		
			...
			if(isset($_POST['del']))
			{
				$sqlll="delete from workson where ssn='$xx'";
				$con->query($sqlll);
